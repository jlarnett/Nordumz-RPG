...
namespace RPG.Skill
{
    public class Miner : MonoBehaviour, IAction, ISkiller
    {
        [SerializeField] private int rockBufferDistance = 2;
        ...
        {
            animator.ResetTrigger("stopSwing");
        ...
        {
            animator.ResetTrigger("swing"); //resetting attack trigger before canceling
        ...
        private bool GetInRange(Transform targetTransfrom)
        {
            ...
            return Vector3.Distance(transform.position, targetTransfrom.position) < rockBufferDistance;
        }
